...
st.subheader("SPY")
st.line_chart(data, y = "SPY", color="#26afd1",height = 350)
st.subheader("VIX")
st.line_chart(data, y = ["VIX", "Z"], color= ["#d1a626", "#26d128"], height = 300)

st.line_chart(data, y = "Z", color="#26d128", height = 150)
