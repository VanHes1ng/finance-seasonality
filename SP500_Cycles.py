...
with col1:
   plot(data.index, data["Sharpe Ratio"], title="Sharpe Ratio", line_style='solid', width = 900, height = 600)
with col2:
   plot(data.index, data["Sortino Ratio"], title="Sortino Ratio", line_color='orange', line_style='solid', width = 900, height = 600)
with col1:
    plot(data.index, data["ROC"], title="Rate of Change", line_color='green', line_style='solid', width = 900, height = 600)
with col2: 
    plot(data.index, data["Z Score"], title="Z Score", line_color='purple', line_style='solid', width = 900, height = 600)
